            ...
            <div className="kt-login__form">
                {/* <form className="kt-form" action=""> */}
                    ...
                    <div className="kt-login__actions">
                        <Button onClick={()=>auth(`mutation { signup(name: "${name}", email: "${email}", password: "${password}") { token, user {name, email, password} } } `)} id="kt_login_signup_submit" className="btn btn-brand btn-pill btn-elevate">Sign Up</Button>
